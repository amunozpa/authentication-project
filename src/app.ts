    ...
    contentSecurityPolicy: {
      directives: {
        ...
        scriptSrc: [
          ...
          // Scripts inline de la página /oauth/device/verify
          "'sha256-3k+3IwhpNEsSjTO+CdT1yuhvf1+9hZEE0syH9Y+Kxfg='",
          "'sha256-TKAWR432/Zhbq88h3WJke80Q7b3X1YYp5fL89gyqeNI='",
          "'sha256-4gjsjjlF2ZtxQi089+kIiQ30hZU2Rt2Kl0VlVfYRoIA='",
